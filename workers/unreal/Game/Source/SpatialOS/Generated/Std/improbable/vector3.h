...
namespace std {
template <>
struct IMPROBABLE_DLL_API hash< ::improbable::Vector3d > {
  size_t operator()(const ::improbable::Vector3d& value) const;
};

template <>
struct IMPROBABLE_DLL_API hash< ::improbable::Vector3f > {
  size_t operator()(const ::improbable::Vector3f& value) const;
};
...
void Write_Vector3d(const ::improbable::Vector3d&, ::worker::detail::internal::Pbio_Object*);

::improbable::Vector3d Read_Vector3d(::worker::detail::internal::Pbio_Object*);

void Write_Vector3f(const ::improbable::Vector3f&, ::worker::detail::internal::Pbio_Object*);

::improbable::Vector3f Read_Vector3f(::worker::detail::internal::Pbio_Object*);
